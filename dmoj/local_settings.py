...
url = urlparse("mysql://root:fBIhINGevgLjZdomggUaaUNbeckveslu@switchback.proxy.rlwy.net:20149/railway")
...
BRIDGED_JUDGE_ADDRESS = [(IPV4, 9999)]
...
EVENT_DAEMON_POST = f'ws://{IPV4}:15101/'
...
EVENT_DAEMON_GET = f'ws://{IPV4}:15100/event/'
